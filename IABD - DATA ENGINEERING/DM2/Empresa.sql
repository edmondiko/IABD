...
VALUES(
    ...
    (
        8,
        'ISC',
        'Cr Sant Silvestre 11',
        777,
        9914213,
        'Sta Coloma de Gramen'
    ),
    (
        9,
        'stucom',
...
VALUES(
    ...
    (
        5,
        'Electricitat Ciurana',
        'Cr Rafael Casanovas 42',
        3853212,
        'Sta Coloma de Gramen'
    ),
    (
